...
<div class="bg-blue-block p-10">
    ...
    @foreach($updates as $update)
        <div class="mb-6">
            ...
            <select name="update_service[{{ $update->id}}]" class="bg-gray-700 border border-gray-600 placeholder-gray-400 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
