...
<div class="bg-blue-block p-10">
    ...
    <form method="POST" action="{{ route('admin.clients.create.tablet') }}">
      @csrf
      <div class="mb-6">
        <label for="tablet_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Име таблет</label>
        <input type="text" name="tablet_name" data-kioskboard-type="all" data-kioskboard-placement="bottom" data-kioskboard-specialcharacters="false" class="bg-gray-50 border border-gray-300 js-virtual-keyboard text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6">
        <label for="floor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Етаж</label>
        <input type="text" name="floor" data-kioskboard-type="all" data-kioskboard-placement="bottom" data-kioskboard-specialcharacters="false" class="bg-gray-50 border border-gray-300 js-virtual-keyboard text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6">
        <label for="room" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Стая</label>
        <input type="text" name="room" data-kioskboard-type="all" data-kioskboard-placement="bottom" data-kioskboard-specialcharacters="false" class="bg-gray-50 border border-gray-300 js-virtual-keyboard text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
...
<div class="bg-blue-block p-10">
    ...
    <form method="POST" action="{{ route('admin.clients.create.server') }}">
      ...
      <div class="mb-6">
        <label for="public_key" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Криптиращ ключ</label>
