...
<div class="bg-blue-block p-10">
    ...
    <form method="POST" action="{{ route('admin.update.parameter', $parameter->id) }}">
      ...
      <div class="mb-6">
        ...
        <input type="text" name="parameter_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" value="{{ $parameter->parameter_name }}" readonly>
      </div>
      ...
      <div class="mb-6">
        ...
        <select name="parameter_value" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      ...
      <div class="mb-6">
        <label for="parameter_value" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Параметър стойност</label>
        <input type="text" name="parameter_value" data-kioskboard-type="all" data-kioskboard-placement="bottom" data-kioskboard-specialcharacters="false" class="bg-gray-50 border border-gray-300 js-virtual-keyboard text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" value="{{ $parameter->parameter_value }}" required>
      </div>
      @endif
