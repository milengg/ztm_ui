...
} elseif ($_instance->childHasBeenRendered('Fi0eaPN')) {
    $componentId = $_instance->getRenderedChildComponentId('Fi0eaPN');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fi0eaPN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fi0eaPN');
} else {
    $response = \Livewire\Livewire::mount('info', []);
    $html = $response->html();
    $_instance->logRenderedChild('Fi0eaPN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ztmUI-prod\resources\views/panel/index.blade.php ENDPATH**/ ?>